...
CalculateTags_Simd:
        ld1r {v12.4s}, [x2] // q12 = inverseDiameter
        mov w13, #0x100
        mov w14, #0x80000
        mov w15, #0x800
...
FindContacts_PostProcess:
        ...
        ldrh              w11, [x4, #16]
        ldrh              w12, [x4, #18]
        prfm              PLDL1KEEP, [x7, w9, SXTW #3]
        prfm              PLDL1KEEP, [x7, w10, SXTW #3]
        prfm              PLDL1KEEP, [x7, w11, SXTW #3]
        prfm              PLDL1KEEP, [x7, w12, SXTW #3]
        ...
        ldrh              w11, [x4, #48]
        ldrh              w12, [x4, #50]
        prfm              PLDL1KEEP, [x7, x9, lsl #3]
        prfm              PLDL1KEEP, [x7, x10, lsl #3]
        prfm              PLDL1KEEP, [x7, x11, lsl #3]
        prfm              PLDL1KEEP, [x7, x12, lsl #3]
...
FindContactsFromChecks_Simd:
        ...
        ldr               w12, [sp, #72]       // w12 = particleDiameterInv
        dup               v14.4s, w12 // v14 = particleDiameterInv
        ldr               x9, [sp, #88]    // x9 = contacts
        ldr               x7, [sp, #80]    // x7 = flags
        ldr               x3, [x9, #0]     // x3 = out = contacts.data
        ldr               w6, [x9, #8]     // w6 = contacts.capacity
        ...
        ld1               {v13.4s}, [x12]     // v13 = *CONST_IS_CLOSE_TABLE_INDICES
...
.L_FindContacts_PostProcessRemainingItems:
        ...
        stp               w5, w30, [sp, #-16]! // Save numContacts and lr
        ...
        ldp               w5, w30, [sp], #16   // Restore numContacts and lr
