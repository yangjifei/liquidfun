...
public class RoundedCornerShapes : MonoBehaviour
{
    ...
    public void GenerateCollider()
    {
        ...
        foreach (FixturePoly fix in GetComponents<FixturePoly>())
        {
            Undo.DestroyObjectImmediate(fix);
        }
        FixtureCircle[] circles = GetComponents<FixtureCircle>();
        ...
        if (polyFixture == null)
        {
            polyFixture = Undo.AddComponent<FixturePoly>(gameObject);
        }
    ...
    internal void Clear()
    {
        ...
        Fixture[] fixtures = gameObject.GetComponents<Fixture>();
